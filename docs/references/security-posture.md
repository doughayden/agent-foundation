...
- Source: [`terraform/main/vpc.tf`](../../terraform/main/vpc.tf) (VPC, firewall rules, Private Services Access)
- Source: [`terraform/main/main.tf`](../../terraform/main/main.tf) (Cloud Run VPC egress)
...
- Source: [`terraform/bootstrap/module/gcp/main.tf`](../../terraform/bootstrap/module/gcp/main.tf) (WIF pool, provider, attribute conditions)
- Source: [`terraform/main/database.tf`](../../terraform/main/database.tf) (IAM database user, password policy)
...
- Source: [`terraform/main/database.tf`](../../terraform/main/database.tf) (connector enforcement, SSL mode, IAM auth flag, deletion protection, backups, maintenance)
...
- **Automatic security updates** — the OS image is updated in its entirety (including the kernel) on an active-passive partition, not package-by-package. Updates take effect on reboot. COS milestone 117+ changed the default to enforce explicit opt-in  — the template explicitly sets `cos-update-strategy = "update_enabled"` in instance metadata to re-enable it.
...
- Source: [`terraform/main/bastion.tf`](../../terraform/main/bastion.tf) (COS image, no public IP, metadata)
- Source: [`terraform/main/templates/bastion-cloud-init.yaml`](../../terraform/main/templates/bastion-cloud-init.yaml) (iptables, systemd proxy service)
...
- Source: [`Dockerfile`](../../Dockerfile) (multi-stage build, non-root user, pinned uv)
...
- Source: [`terraform/main/main.tf`](../../terraform/main/main.tf) (GCS bucket configuration)
